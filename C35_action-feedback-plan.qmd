...
author:
  - name: Andrew MacLaren
    ...
    affiliations: School of Social Sciences, Heriot-Watt University

  - name: Frederik Madsen
    email: f.d.madsen@sms.ed.ac.uk
    affiliations: School of GeoSciences, University of Edinburgh; Lyell Centre, British Geological Survey

  - name: Antonia Voigt
    email: a.voigt@surrey.ac.uk
    affiliations: Surrey Business School, University of Surrey

  - name: Alex Buckley
    email: Alex.Buckley@hw.ac.uk
    affiliations: Learning and Teaching Academy, Heriot-Watt University
