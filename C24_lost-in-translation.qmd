...
![Different approaches to translating teaching materials: from professional services to platforms and customized workflows.](/chapters/images/C24_Fig_1.svg "Different approaches to translating teaching materials"){fig-alt="Different approaches to translating teaching materials depending on the output that needs to be generated and the aims of the translation project. Three main approaches are outlined: professional translators, translation management platforms, and tailored solutions, with examples given for each."}
...
![Translation workflow for training materials, showing how translation, review, and feedback interact with supporting resources like translation guides and glossaries, and style conventions.](/chapters/images/C24_Fig_2.svg "Translation workflow for training materials"){fig-alt="Translation workflow that highlight the iterative process across the different phases"}
